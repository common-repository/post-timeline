          ...
          <div class="col-lg-4 col-md-4">
             <div class="nav-wrapper">
                <ul class="nav nav-tabs container tabbing_list" id="tabs-icons-text" role="tablist">
                   <li class="nav-item"> 
                      <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-basic" data-toggle="tab" href="#tabs-basic-content" role="tab" aria-controls="tabs-basic-content" aria-selected="true">
                        <span class="tab_title"><?php echo esc_attr__('Basic','post-timeline'); ?></span>
                        <i class="fa-regular fa-chess-bishop"></i>
                      </a>
                   </li>
                   <li class="nav-item">
                      <a class="nav-link mb-sm-3 mb-md-0" id="tabs-styles" data-toggle="tab" href="#tabs-styles-content" role="tab" aria-controls="tabs-styles-content" aria-selected="false">
                        <span class="tab_title"><?php echo esc_attr__('Styles','post-timeline'); ?></span>
                        <i class="fa fa-clone"></i>
                        <!-- <i class="fa-solid fa-bring-forward"></i> -->
                      </a>
                   </li>
                   <li class="nav-item">
                      <a class="nav-link mb-sm-3 mb-md-0" id="tabs-navigation" data-toggle="tab" href="#tabs-navigation-content" role="tab" aria-controls="tabs-navigation-content" aria-selected="false">
                        <span class="tab_title"><?php echo esc_attr__('Navigation','post-timeline'); ?></span>
                        <i class="fa-solid fa-location-arrow"></i>
                      </a>
                   </li>
                   <li class="nav-item">
                      <a class="nav-link mb-sm-3 mb-md-0" id="tabs-animation" data-toggle="tab" href="#tabs-animation-content" role="tab" aria-controls="tabs-animation-content" aria-selected="false">
                        <span class="tab_title"><?php echo esc_attr__('Animation','post-timeline'); ?></span>
                        <i class="fa-solid fa-circle-radiation"></i>
                      </a>
                   </li>
                   <li class="nav-item">
                      <a class="nav-link mb-sm-3 mb-md-0" id="tabs-custom" data-toggle="tab" href="#tabs-custom-content" role="tab" aria-controls="tabs-custom-content" aria-selected="false">
                    ...
                    <div class="tab-content" id="myTabContent">
                          ...
                          <div class="row">
                             <div class="col-md-12">
                                <div class="group-title">
                                   <h4><?php echo esc_attr__('Basic','post-timeline'); ?></h4>
                                </div>
                                         ...
                                         <div class="field-content">
                                            <div class="row align-items-center">
                                              <div class="col-lg-2 col-md-3 col-sm-3 col-3">
                                                <label class="custom-toggle" for="ptl-post-icon"><input type="checkbox" <?php echo ($options['ptl-post-icon'] == 'on') ? 'checked' : '' ?> value="<?php echo $options['ptl-post-icon'] ?>" name="ptl-post-icon" id="ptl-post-icon"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                              </div>
                                    ...
                                    <div class="row justify-content-between">
                                      <div class="col-md-8 col-sm-8 col-12">
                                         ...
                                         <div class="field-content">
                                          <div class="row align-items-center">
                                            <div class="col-lg-2 col-md-3 col-sm-3 col-3">
                                              <label class="custom-toggle" for="ptl-images"><input <?php echo ($options['ptl-images'] == 'on') ? 'checked' : '' ?> type="checkbox" value="<?php echo $options['ptl-images'] ?>" name="ptl-images" id="ptl-images"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                            </div>
                                            <div class="col-lg-10 col-md-9 col-sm-9 col-9">
                                     ...
                                     <div class="col-md-8 col-sm-8 col-12">
                                       <div class="field-set">
                                          ...
                                          <div class="field-content">
                                             <div class="row align-items-center">
                                               <div class="col-lg-2 col-md-3 col-sm-3 col-3">
                                                 <label class="custom-toggle" for="ptl-content-hide"><input type="checkbox" <?php echo ($options['ptl-content-hide'] == 'on') ? 'checked' : '' ?> value="<?php echo $options['ptl-content-hide'] ?>" name="ptl-content-hide" id="ptl-content-hide"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                               </div>
                                               <div class="col-lg-10 col-md-9 col-sm-9 col-9">
                                ...
                                <div class="input-group input-group-merge">
                                   ...
                                   <div class="field-content">
                                      ...
                                      <div class="ptl-fav-icon <?php echo ($options['ptl-icon-type'] != 'font-awesome') ? 'hide' : '' ?>">
                                         <div class="d-flex">
                                           <input type="text" name="ptl-fav-icon" id="ptl-fav-icon" value="<?php echo $options['ptl-fav-icon'] ?>">
                                ...
                                <div class="input-group input-group-merge">
                                     ...
                                     <div class="field-content">
                                        <div class="field-content-inner">
                                          <select id="ptl-sort" name="ptl-sort" class="custom-nice-select">
                                ...
                                <div class="input-group input-group-merge">
                                     <div class="field-title">
                                        <?php echo esc_attr__('Post Date','post-timeline') ?>
                                     </div>
                                     <div class="field-content">
                                        <div class="field-content-inner">
                                          <select name="ptl-date-format" id="ptl-date-format" class="ptl-select custom-nice-select">
                                ...
                                <div class="input-group input-group-merge">
                                     <div class="field-title">
                                        <?php echo esc_attr__('Post Link Type','post-timeline') ?>
                                     </div>
                                     <div class="field-content">
                                        <div class="field-content-inner">
                                          <select id="ptl-post-link-type" name="ptl-post-link-type" class="custom-nice-select">
                                ...
                                <div class="input-group input-group-merge">
                                     ...
                                     <div class="field-content">
                                        <input type="number" class="ptl-text-fields" name="ptl-post-length" id="ptl-post-length" value="<?php echo $options['ptl-post-length'] ?>" placeholder="<?php echo esc_attr__('Numberic Value (Example: 24)','post-timeline') ?>">
                                ...
                                <div class="input-group input-group-merge">
                                     ...
                                     <div class="field-content">
                                        <input type="text" class="ptl-text-fields" name="ptl-slug" id="ptl-slug" value="<?php echo $options['ptl-slug'] ?>" placeholder="<?php echo esc_attr__('post-timeline-slug','post-timeline') ?>">
                          ...
                          <div class="row">
                             <div class="col-md-12">
                                 <div class="input-group input-group-merge">
                                     ...
                                     <div class="field-content">
                                        <div class="field-content-inner">
                                            <select  id="ptl-slides-setting" name="ptl-slides-setting" class="custom-nice-select">
                                 ...
                                 <div class="input-group input-group-merge">
                                     <div class="field-title">
                                        <?php echo esc_attr__('Select Pagination','p_timeline') ?><span class="ptl-go-pro"><a href="https://posttimeline.com/" target="__blank"><?php echo esc_attr__('Go Pro','post-timeline') ?></a></span>
                                     </div>
                                     <div class="field-content">
                                        <div class="field-content-inner">
                                            <select  id="ptl-pagination" name="ptl-pagination" class="custom-nice-select">
                                             <option <?php echo ($options['ptl-pagination'] == 'carousel') ? 'selected' : '' ?> value="off"><?php echo esc_attr__('Disable','p_timeline'); ?></option>
                                             <option <?php echo ($options['ptl-pagination'] == 'button') ? 'selected' : '' ?> value="button"><?php echo esc_attr__('Load more Button','p_timeline'); ?></option>
                                             <option disabled value=""><?php echo esc_attr__('Load more on Scroll','p_timeline'); ?> </option>
                                            </select>
                                        </div>
                                        <div class="options-group"></div>
                                        <div class="description"><?php echo esc_attr__('Select how more posts will be loaded on the timeline.','p_timeline'); ?></div>
                                     </div>
                                 </div>
                             </div>
                          </div>
                                        ...
                                        <div class="col-lg-8 col-md-8 ptl-lock-box">
                                          ...
                                          <div class="row align-items-center mb-2">
                                            ...
                                            <div class="col-lg-10 col-md-9 col-sm-10 col-10">
                                              <label class="custom-toggle" for="ptl_facebook"><input disabled="disabled" type="checkbox" value="" name="social-shares[ptl_facebook]" id="ptl_facebook" class="ptl-social-shares"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                            </div>
                                          </div>
                                          <div class="row align-items-center mb-2">
                                            <div class="col-lg-2 col-md-3 col-sm-2 col-2">
                                            ...
                                            <div class="col-lg-10 col-md-9 col-sm-10 col-10">
                                              <label class="custom-toggle" for="ptl_twitter"><input  disabled="disabled"  type="checkbox" value="" name="social-shares[ptl_twitter]" id="ptl_twitter" class="ptl-social-shares"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                            </div>
                                          </div>
                                          <div class="row align-items-center mb-2">
                                            <div class="col-lg-2 col-md-3 col-sm-2 col-2">
                                            ...
                                            <div class="col-lg-10 col-md-9 col-sm-10 col-10">
                                              <label class="custom-toggle" for="ptl_linkedin"><input  disabled="disabled"  type="checkbox" value="" name="social-shares[ptl_linkedin]" id="ptl_linkedin" class="ptl-social-shares"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                            </div>
                                          </div>
                                          <div class="row align-items-center mb-2">
                                            <div class="col-lg-2 col-md-3 col-sm-2 col-2">
                                            ...
                                            <div class="col-lg-10 col-md-9 col-sm-10 col-10">
                                              <label class="custom-toggle" for="ptl_pinterest"><input  disabled="disabled" type="checkbox" value="" name="social-shares[ptl_pinterest]" id="ptl_pinterest" class="ptl-social-shares"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                       ...
                       <div class="tab-pane" id="tabs-styles-content" role="tabpanel" aria-labelledby="tabs-styles">
                          <div class="row">
                             <div class="col-md-12">
                                <div class="group-title">
                                   <h4><?php echo esc_attr__('Fonts','post-timeline'); ?></h4>
                                </div>
                                 <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       <div class="field-title">
                                          <?php echo esc_attr__('Select Font','post-timeline') ?>
                                       </div>
                                       <div class="field-content">
                                          <div class="field-content-inner ptl-search-active">
                                            <select  id="ptl-fonts-title" name="ptl-fonts-title" class="custom-nice-select">
                                 ...
                                 <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       <div class="field-title">
                                          <?php echo esc_attr__('Content Font Size','post-timeline') ?>
                                       </div>
                                       <div class="field-content">
                                          <div class="ptl-unit">
                                            <input type="number" class="ptl-text-fields" name="ptl-size-content" id="ptl-size-content" value="<?php echo $options['ptl-size-content'] ?>" min="0" max="30" placeholder="<?php echo esc_attr__('14','post-timeline') ?>">
                                          </div>
                          ...
                          <div class="row">
                             <div class="col-md-12">
                                <div class="group-title">
                                   <h4><?php echo esc_attr__('Style','post-timeline'); ?></h4>
                                </div>
                                <div class="input-group input-group-merge">
                                  <div class="field-title">
                                    <?php echo esc_attr__('Skin Type','post-timeline') ?>
                                  </div>
                                  <div class="field-content">
                                    <div class="row">
                                      <div class="col-md-10">
                                ...
                                <div class="input-group input-group-merge">
                                     ...
                                     <div class="field-content">
                                        <div class="field-content-inner">
                                          <select id="ptl-post-radius" name="ptl-post-radius" class="custom-nice-select">
                                ...
                                <div class="input-group input-group-merge">
                                     ...
                                     <div class="field-content">
                                        <div class="field-content-inner">
                                          <select name="ptl-line-style" id="ptl-line-style" class="ptl-select custom-nice-select">
                                 ...
                                 <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       <div class="field-title">
                                          <?php echo esc_attr__('Container Background Color','post-timeline') ?>
                                       </div>
                                       <div class="field-content">
                                    ...
                                    <div class="field-set">
                                       ...
                                       <div class="field-content ptl-colorpicker-box post_field">
                                        <div style="position: relative;">
                                            <input type="text" class="colorpicker_value" id="ptl-bg-color-text" value="<?php echo $options['ptl-bg-color'] ?>" class="hexcolor" name="ptl-bg-color-text" >
                                            <input type="color" class="colorpicker" id="ptl-bg-color" name="ptl-bg-color" value="<?php echo $options['ptl-bg-color'] ?>">
                                        </div>
                                 ...
                                 <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       <div class="field-title">
                                          <?php echo esc_attr__('Post Background','post-timeline') ?>
                                       </div>
                                       <div class="field-content ptl-colorpicker-box post_field">
                                          <div style="position: relative;">
                                              <input type="text" class="colorpicker_value" id="ptl-post-bg-color-text" class="hexcolor" name="ptl-post-bg-color-text"  value="<?php echo $options['ptl-post-bg-color'] ?>">
                                              <input type="color" class="colorpicker" id="ptl-post-bg-color" name="ptl-post-bg-color"  value="<?php echo $options['ptl-post-bg-color'] ?>">
                                          </div>
                       ...
                       <div class="tab-pane" id="tabs-navigation-content" role="tabpanel" aria-labelledby="tabs-navigation">
                          <div class="row">
                             <div class="col-md-12">
                                <div class="group-title">
                                 ...
                                 <div class="input-group input-group-merge">
                                  <div class="row justify-content-between">
                                    <div class="col-md-8 col-sm-8 col-12">
                                      <div class="field-set">
                                         <div class="field-title">
                                            <?php echo esc_attr__('Navigation Enabled','post-timeline') ?>
                                         </div>
                                         <div class="field-content">
                                            <div class="row align-items-center">
                                              <div class="col-lg-2 col-md-3 col-sm-3 col-3">
                                                <label class="custom-toggle" for="ptl-nav-status">
                                                <input type="checkbox" <?php echo ($options['ptl-nav-status'] == 'on') ? 'checked' : '' ?> value="<?php echo $options['ptl-nav-status'] ?>" name="ptl-nav-status" id="ptl-nav-status"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                              </div>
                                              <div class="col-lg-10 col-md-9 col-sm-9 col-9">
                                 ...
                                 <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       <div class="field-title">
                                          <?php echo esc_attr__('Navigation Type','p_timeline') ?><span class="ptl-go-pro"><a href="https://posttimeline.com/" target="__blank"><?php echo esc_attr__('Go Pro','post-timeline') ?></a></span>
                                       </div>
                                       <div class="field-content disabled">
                                          ...
                                          <div class="description"><?php echo esc_attr__('Select a timeline navigation style.','p_timeline'); ?></div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       ...
                                       <div class="field-content ptl-colorpicker-box post_field">
                                        <div style="position: relative;"ptl-colorpicker-box>
                                            <input type="text" class="hexcolor colorpicker_value" id="ptl-nav-color-text" name="ptl-nav-color-text"  value="<?php echo $options['ptl-nav-color'] ?>">
                                            <input type="color" class="colorpicker" id="ptl-nav-color" name="ptl-nav-color"  value="<?php echo $options['ptl-nav-color'] ?>">
                                        </div>
                                 ...
                                 <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       <div class="field-title">
                                          <?php echo esc_attr__('Tag Line Color','post-timeline') ?>
                                       </div>
                                       <div class="field-content ptl-colorpicker-box post_field">
                                        <div style="position: relative;"ptl-colorpicker-box>
                                            <input type="text" class="hexcolor colorpicker_value" id="ptl-tagline-color-text" name="ptl-tagline-color-text"  value="<?php echo $options['ptl-tagline-color'] ?>">
                                            <input type="color" class="colorpicker" id="ptl-tagline-color" name="ptl-tagline-color"  value="<?php echo $options['ptl-tagline-color'] ?>">
                                        </div>
                                 ...
                                 <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       ...
                                       <div class="field-content">
                                          <input type="number" class="ptl-text-fields" name="ptl-post-per-page" id="ptl-post-per-page" value="<?php echo $options['ptl-post-per-page'] ?>" placeholder="<?php echo esc_attr__('Numberic Value (Example: 10)','post-timeline') ?>">
                       ...
                       <div class="tab-pane" id="tabs-animation-content" role="tabpanel" aria-labelledby="tabs-animation">
                          <div class="row">
                             <div class="col-md-12">
                                <div class="group-title">
                                  ...
                                  <div class="input-group input-group-merge">
                                    <div class="row justify-content-between">
                                      <div class="col-md-8 col-sm-8 col-12">
                                        <div class="field-set">
                                           <div class="field-title">
                                              <?php echo esc_attr__('Animation Enabled','post-timeline') ?>
                                           </div>
                                           <div class="field-content">
                                              <div class="row align-items-center">
                                                <div class="col-lg-2 col-md-3 col-sm-3 col-3">
                                                  <label class="custom-toggle" for="ptl-anim-status"><input type="checkbox" <?php echo ($options['ptl-anim-status'] == 'on') ? 'checked' : '' ?> value="<?php echo $options['ptl-anim-status'] ?>" name="ptl-anim-status" id="ptl-anim-status"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                                </div>
                                                <div class="col-lg-10 col-md-9 col-sm-9 col-9">
                                  ...
                                  <div class="input-group input-group-merge">
                                    <div class="row justify-content-between">
                                      <div class="col-md-8 col-sm-8 col-12">
                                        <div class="field-set">
                                           <div class="field-title">
                                              <?php echo esc_attr__('Animation on scroll','post-timeline') ?>
                                           </div>
                                           <div class="field-content">
                                              <div class="row align-items-center">
                                                <div class="col-lg-2 col-md-3 col-sm-3 col-3">
                                                  <label class="custom-toggle" for="ptl-scroll-anim"><input type="checkbox" <?php echo ($options['ptl-scroll-anim'] == 'on') ? 'checked' : '' ?> value="<?php echo $options['ptl-scroll-anim'] ?>" name="ptl-scroll-anim" id="ptl-scroll-anim"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                                </div>
                                                <div class="col-lg-10 col-md-9 col-sm-9 col-9">
                                                  <div class="label"><?php echo esc_attr__('Experience posts animation by scrolling up or down','post-timeline'); ?></div>
                                                </div>
                                              </div>
                                           </div>
                                        </div>
                                  ...
                                  <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       ...
                                       <div class="field-content">
                                          <div class="field-content-inner">
                                            <select name="ptl-anim-type" id="ptl-anim-type" class="ptl-select custom-nice-select">
                                              <?php
                                                $animations = array(
                                                  ...
                                                  foreach ($animations as $animKey => $animVal) {
                                                    ...
                                                    echo '<option '.$selected.' value="'.$animKey.'">'.$animVal.'</option>';
                                                  }
                                              ?>
                                            </select>
                                          </div>
                                  ...
                                  <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       ...
                                       <div class="field-content">
                                            <input type="number" class="ptl-text-fields" name="ptl-anim-speed" id="ptl-anim-speed" value="<?php echo $options['ptl-anim-speed'] ?>" min="0.1" step="0.1" max="2" placeholder="<?php echo esc_attr__('0.5','post-timeline') ?>">
                                  ...
                                  <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       <div class="field-title">
                                          <?php echo esc_attr__('Animation Easing','post-timeline') ?>
                                       </div>
                                       <div class="field-content">
                                          <div class="field-content-inner">
                                            ...
                                            ?>
                                            <select name="ptl-easing" id="ptl-easing" class="ptl-select custom-nice-select">
                                              <?php 
                                  ...
                                  <div class="input-group input-group-merge <?php echo ($options['ptl-lazy-load'] == 'off') ? 'ptl-off' : '' ?>">
                                      <div class="row justify-content-between">
                                        <div class="col-md-8 col-sm-8 col-12">
                                          <div class="field-set">
                                           <div class="field-title">
                                           ...
                                           <div class="field-content">
                                              <div class="row align-items-center">
                                                <div class="col-lg-2 col-md-3 col-sm-3 col-3">
                                                  <label class="custom-toggle" for="ptl-lazy-load"><input type="checkbox" <?php echo ($options['ptl-lazy-load'] == 'on') ? 'checked' : '' ?> value="<?php echo $options['ptl-lazy-load'] ?>" name="ptl-lazy-load" id="ptl-lazy-load"><span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span></label>
                                                </div>
                                                <div class="col-lg-10 col-md-9 col-sm-9 col-9">
                                  ...
                                  <div class="input-group input-group-merge">
                                    <div class="field-set">
                                       ...
                                       <div class="field-content position-relative">
                                          <div class="field-content-inner">
                                            <select name="ptl-loader" id="ptl-loader" class="ptl-select custom-nice-select">
                                          ...
                                          <div class="loader-sec">
                                             <?php
                                                if ($options['ptl-loader']) {
                                                  echo '<span class="'.$options['ptl-loader'].'"></span>';
                                                }
                                                ?>
                                          </div>
