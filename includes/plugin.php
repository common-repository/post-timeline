...
class Plugin {
	...
	public function __construct() {
		...
		add_action('wp_ajax_ptl_save_setting', array($this->admin_plugin, 'save_setting'));	
		//add_action('wp_ajax_nopriv_ptl_save_setting', array($this->admin_plugin, 'save_setting'));

		add_action('wp_ajax_ptl_get_fonts_options', array($this->admin_plugin, 'get_fonts_options'));	
		//add_action('wp_ajax_nopriv_ptl_get_fonts_options', array($this->admin_plugin, 'get_fonts_options'));

		add_action('wp_ajax_ptl_select_modal_posttype', array($this->admin_plugin, 'select_modal_posttype'));	
		//add_action('wp_ajax_nopriv_ptl_select_modal_posttype', array($this->admin_plugin, 'select_modal_posttype'));

		add_action('wp_ajax_ptl_select_layout', array($this->admin_plugin, 'select_layout'));	
		//add_action('wp_ajax_nopriv_ptl_select_layout', array($this->admin_plugin, 'select_layout'));

		add_action('wp_ajax_ptl_selected_post_types', array($this->admin_plugin, 'selected_post_types'));	
		//add_action('wp_ajax_nopriv_ptl_selected_post_types', array($this->admin_plugin, 'selected_post_types'));

		add_action('wp_ajax_ptl_selected_taxonomy', array($this->admin_plugin, 'selected_taxonomy'));	
		//add_action('wp_ajax_nopriv_ptl_selected_taxonomy', array($this->admin_plugin, 'selected_taxonomy'));
		
		add_action('wp_ajax_ptl_generate_shorcode', array($this->admin_plugin, 'generate_shorcode'));	
		//add_action('wp_ajax_nopriv_ptl_generate_shorcode', array($this->admin_plugin, 'generate_shorcode'));

		// update ptl tag menu order 
		add_action( 'wp_ajax_update-menu-order-tags', array( $this->admin_plugin, 'update_menu_order_tags' ) );
	...
	private function define_admin_hooks() {
	    ...
	    if(is_admin()) {
		    ...
		    require_once POST_TIMELINE_PLUGIN_PATH.'admin/blocks/index.php';
			 //  $this->loader->add_action( 'init', $this->admin_plugin, 'register_post_timeline_settings_page' );
			 //  $this->loader->add_action( 'admin_init', $this->admin_plugin, 'add_post_timeline_meta_box' );
				// $this->loader->add_action( 'after_setup_theme', $this->admin_plugin, 'include_optiontree' );
