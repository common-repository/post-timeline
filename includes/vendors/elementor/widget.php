...
class Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
		 	'pagination',
		 	[
				'label' => __( 'Ajax Loader', 'post-timeline' ),
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'horizontal' => __( 'Horizontal Layout', 'post-timeline' ),
			...
			$this->add_control(
			 ...
			 $this->add_control(
				...
				[
					...
					'options' => [
						...
						'1' => __( "Template 1",'post-timeline') ,
						'2' => __( "Template 2",'post-timeline') ,
						'3' => __( "Template 3",'post-timeline') ,	
					]
			 ...
			 $this->add_control(
				...
				[
					...
					'default' => 'style-0',
					'options' => [
						'style-0' => __( "Style 0",'post-timeline' ) ,
						'style-1' => __( "Style 1",'post-timeline') ,
						'style-2' => __( "Style 2",'post-timeline') ,
						'style-3' => __( "Style 3",'post-timeline') ,	
					]
			...
			$this->add_control(
			 	...
			 	[
					...
					'default' => 'fadeInUp',
					'options' => [
						'fadeInUp' => __( "Slide Up",'post-timeline' ) ,
						'flipInY' => __( "Flip Y",'post-timeline') ,
						'flipInX' => __( "Flip X",'post-timeline') ,
						'zoomInUp' => __( "ZoomInUp",'post-timeline') ,	
						'zoomInDown' => __( "ZoomInDown",'post-timeline') ,	
						'bounceIn' => __( "BounceIn",'post-timeline') ,	
						'bounceInUp' => __( "BounceInUp",'post-timeline') ,	
					],
					'condition'   => [
						'layout!'   =>	'horizontal',
					]
